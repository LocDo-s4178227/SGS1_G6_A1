...
This update connects the static prototype modules to the Node.js backend and makes user-specific data persist through the existing JSON data store. Decide whether you want me to commit the changes to main branch or not.
